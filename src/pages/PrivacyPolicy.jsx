...
export default function PrivacyPolicy() {
  ...
  return (
    ...
    <p>At [Your Company Name], we are committed to protecting your privacy. This Privacy Policy outlines how we collect, use, and safeguard your personal information when you visit our website or use our services related to property sales and rentals.</p>

    <h3>1. Information We Collect</h3>
    <ul>
        <li><strong>Personal Information:</strong> Name, email address, phone number, and mailing address.</li>
        <li><strong>Property Details:</strong> Information about properties you list or inquire about.</li>
        <li><strong>Payment Information:</strong> For processing transactions securely.</li>
        <li><strong>Usage Data:</strong> IP address, browser type, and browsing behavior on our website.</li>
    </ul>

    <h3>2. How We Use Your Information</h3>
    <ul>
        <li>Provide and manage property listings and rental services.</li>
        <li>Respond to your inquiries and customer support requests.</li>
        <li>Process transactions securely.</li>
        <li>Improve our website and services.</li>
        <li>Send you relevant updates, promotions, or property listings (if you opt-in).</li>
    </ul>

    <h3>3. Sharing Your Information</h3>
    <p>We may share your data with:</p>
    <ul>
        <li><strong>Service Providers:</strong> Trusted third-party services that assist in our operations (e.g., payment processors, marketing tools).</li>
        <li><strong>Legal Obligations:</strong> If required by law or to protect our rights.</li>
    </ul>
    <p>We do <strong>not</strong> sell or trade your personal information to third parties.</p>

    <h3>4. Data Security</h3>
    <p>We implement security measures such as encryption and secure servers to protect your data from unauthorized access, disclosure, or alteration.</p>

    <h3>5. Cookies and Tracking Technologies</h3>
    <p>We use cookies and similar technologies to improve user experience and analyze website performance. You can manage your cookie preferences through your browser settings.</p>

    <h3>6. Third-Party Links</h3>
    <p>Our website may contain links to third-party websites. We are not responsible for their privacy practices and recommend reviewing their policies separately.</p>
    ...
    <p>We may update this Privacy Policy as needed to reflect changes in our services or legal requirements. We encourage you to review this policy periodically.</p>

    <h3>9. Contact Us</h3>
    <p>If you have any questions about this Privacy Policy or how we handle your data, please contact us at:</p>
    <p><strong>[Your Company Name]</strong><br />[Your Contact Email]<br />[Your Contact Phone Number]</p>
