...
export default function Home() {
  ...
  return (
	...
	******************************** --> */}
          ...
          <div className="swiper-wrapper">
            <div className="swiper-slide">
              <div
                ...
                style={{
                  WebkitMaskImage: "url('assets/img/hero/hero_1_bg_mask.png')",
                  maskImage: "url('assets/img/hero/hero_1_bg_mask.png')",
          ...
          <div className="row gy-4">
            <div className="col-lg-6">
              <div className="img-box1">
                <div
                  className="img1 img-shine"
                  style={{
                    WebkitMaskImage: "url('assets/img/shape/about-1-mask.png')",
                    maskImage: "url('assets/img/shape/about-1-mask.png')",
                    WebkitMaskSize: "cover",
                    maskSize: "cover",
                    WebkitMaskRepeat: "no-repeat",
                    maskRepeat: "no-repeat",
              ...
              <div className="col-xl-9">
                <div className="about-wrap1">
                  <p className="about-text text-white">
                    ...
                    and confident purchase, sale, and management of your
                    properties.
                  </p>
                </div>
              </div>
      ...
      {/* <!--Service Area  --> */}
      <section
        className="service-area-1 overflow-hidden space-bottom bg-theme pt-80"
        id="service-sec"
      >
        <div className="container">
              ...
              <div className="service-card">
                ...
                <div className="box-content">
                  ...
                  <p className="box-text">
                    ...
                    services to real estate improve performance services and
                    achieve.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-card">
                ...
                <div className="box-content">
                  ...
                  <p className="box-text">
                    Real estate services facilitate the easy and confident
      ...
      >
        <div className="container-fluid">
          <div className="project-wrap1">
            <div
              className="project-number-pagination"
              data-slider-tab="#projectSlider1"
            >
                ...
                <div className="project-title-wrap1">
                  <div className="title-area mb-40">
                    ...
                    <h2 className="sec-title text-white">
                      Discover Modern Living At Realar Residence.
                    </h2>
                    <p className="sec-text text-white mt-15">
                      Residence takes advantage of abundant sunlight by
                      incorporating solar panels into its architecture.
                    </p>
                  </div>
                      ...
                      <div className="swiper-slide">
                        <div className="portfolio-card">
                          <div
                            ...
                            style={{
                              maskImage:
                                'url("assets/img/shape/project-card1-img-mask.png")',
                              WebkitMaskImage:
                                'url("assets/img/shape/project-card1-img-mask.png")',
                              maskSize: "cover",
                              WebkitMaskSize: "cover",
        ...
        <div className="container">
          ...
          <div className="property-card-wrap">
            <div
              ...
              style={{
                WebkitMaskImage:
                  "url('assets/img/shape/property-card1-img-mask.png')",
                maskImage:
                  "url('assets/img/shape/property-card1-img-mask.png')",
                WebkitMaskSize: "cover",
                maskSize: "cover",
            ...
            <div className="property-card">
              ...
              <div className="property-card-details">
                ...
                <div className="property-card-meta">
                  <span>
                    <img src="assets/img/icon/property-icon1-1.svg" alt="img" />
                    Bed 4
                  </span>
                  <span>
                    <img src="assets/img/icon/property-icon1-2.svg" alt="img" />
                    Bath 2
                  </span>
                  <span>
                    <img src="assets/img/icon/property-icon1-3.svg" alt="img" />
                    1500 sqft
                  </span>
                </div>
          ...
          <div className="property-card-wrap">
            ...
            <div className="property-card">
              ...
              <div className="property-card-details">
                <span className="property-card-subtitle">Apartment</span>
                <h4 className="property-card-title">
                  <a href="">Virgin Vineyard House</a>
                </h4>
                <p className="property-card-text">
                  Rapidiously myocardinate cross-platform intellectual capital
                  model. Appropriately create interactive infrastructures
      ...
      <section className="space overflow-hidden">
        <div className="container">
          ...
          <div
            ...
            id="aminitiesSlider1"
            data-slider-options='{"breakpoints":{"0":{"slidesPerView":1},"375":{"slidesPerView":"2"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"4"},"1200":{"slidesPerView":"6"}}}'
          >
            <div className="swiper-wrapper">
              <div className="swiper-slide">
                <a
                  ...
                  style={{
                    WebkitMaskImage:
                      "url('assets/img/theme-img/aminities-shape1.png')",
                    maskImage:
                      "url('assets/img/theme-img/aminities-shape1.png')",
                    WebkitMaskSize: "cover",
                    maskSize: "cover",
                ...
                >
                  ...
                  <div className="aminities-content">
                    <div className="aminities-card-icon">
                      <img
                        src="assets/img/icon/aminities-icon1-1.svg"
                        alt="aminities icon"
                      />
                    </div>
              ...
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="aminities-content">
                    <div className="aminities-card-icon">
                      <img
                        src="assets/img/icon/aminities-icon1-2.svg"
                        alt="aminities icon"
                      />
                    </div>
              ...
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="aminities-content">
                    <div className="aminities-card-icon">
                      <img
                        src="assets/img/icon/aminities-icon1-3.svg"
                        alt="aminities icon"
                      />
                    </div>
              ...
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="aminities-content">
                    <div className="aminities-card-icon">
                      <img
                        src="assets/img/icon/aminities-icon1-4.svg"
                        alt="aminities icon"
                      />
                    </div>
              ...
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="aminities-content">
                    <div className="aminities-card-icon">
                      <img
                        src="assets/img/icon/aminities-icon1-5.svg"
                        alt="aminities icon"
                      />
                    </div>
              ...
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="aminities-content">
                    <div className="aminities-card-icon">
                      <img
                        src="assets/img/icon/aminities-icon1-6.svg"
                        alt="aminities icon"
                      />
                    </div>
            ...
            <div className="slider-pagination"></div>
            <button
              data-slider-prev="#aminitiesSlider1"
              className="slider-arrow slider-prev"
            >
              <img src="assets/img/icon/arrow-left.svg" alt="icon" />
            </button>
            <button
              data-slider-next="#aminitiesSlider1"
            ...
            <div className="video-wrap-details">
              <div className="title-area mb-45">
                ...
                <p className="sec-text text-title">
                  We are a real estate firm with over 20 years of expertise, and
                  our main goal is to provide amazing locations to our partners
                  and clients. Within the luxury real estate market, our agency
      ...
      <section className="team-area-1 space-bottom bg-theme">
        <div className="container z-index-common">
          ...
          <div
            className="swiper th-slider team-slider1"
            id="teamSlider1"
          ...
          <div className="row gy-80 gx-40 align-items-center">
            <div className="col-xl-6">
              <div
                ...
                style={{
                  WebkitMaskImage:
                    "url('assets/img/shape/cta_1_1-img-mask.png')",
                  maskImage: "url('assets/img/shape/cta_1_1-img-mask.png')",
                  WebkitMaskSize: "cover",
                  maskSize: "cover",
                  WebkitMaskRepeat: "no-repeat",
                  maskRepeat: "no-repeat",
            ...
            <div className="col-xl-6">
              <div className="me-xxl-5 pe-xxl-5">
                <div className="title-area">
                  ...
                  <h2 className="sec-title text-white">
                    Buying & Selling We Make It Simple
                  </h2>
                  <p className="sec-text text-white">
                    Rapidiously myocardinate cross-platform intellectual capital
                    model. Appropriately create interactive infrastructures
                  ...
                  <div className="swiper-slide">
                    <div className="testi-card">
                      ...
                      <p className="testi-card_text">
                        ...
                        beautiful property. Finding the perfect that resonates
                        with your own coupled with modern.
                      </p>
                      <div className="testi-grid-wrap">
                        <div className="testi-card_profile">
                          <div
                  ...
                  <div className="swiper-slide">
                    <div className="testi-card">
                      ...
                      <p className="testi-card_text">
                        ...
                        wanted to live commitment to living.
                      </p>
                      <div className="testi-grid-wrap">
                        <div className="testi-card_profile">
                          <div
      ...
      <section className="space bg-theme" id="blog-sec">
        <div className="container">
          ...
          <div className="blog-grid">
            <div
              className="blog-img img-shine"
              style={{
                WebkitMaskImage:
                  "url('assets/img/shape/blog-card1-img-mask.png')",
                maskImage: "url('assets/img/shape/blog-card1-img-mask.png')",
                WebkitMaskSize: "cover",
                maskSize: "cover",
                WebkitMaskRepeat: "no-repeat",
                maskRepeat: "no-repeat",
            ...
            <div className="blog-content">
              ...
              <h3 className="box-title">
                <a href="">
                  Imaging Trends Will Shape the Future of Architecture Design
                </a>
              </h3>
          ...
          <div className="blog-grid">
            ...
            <div className="blog-content">
              ...
              <h3 className="box-title">
                <a href="">
                  We endowed Villa 1 with interestingly spatial experiences.
                </a>
              </h3>
              <p className="blog-text">
                Rapidiously myocardinate cross-platform intellectual capital
