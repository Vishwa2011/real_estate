...
export default function Contact() {
  ...
  const validate = () => {
    ...
    if (!formData.subject) tempErrors.subject = "Please select a service type.";
  ...
  return (
    <div className="bg-smoke">
      ...
      <div
        ...
        style={{
          backgroundImage: `url('/assets/pic/contactmain.jpg')`,
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="about-contact-grid style2">
                ...
                <div className="about-contact-details">
                  ...
                  <p className="about-contact-details-text">
                    <a href="mailto:mailinfo00@realar.com">
                      mailinfo00@realar.com
                    </a>
                  </p>
                  <p className="about-contact-details-text">
                    <a href="mailto:support24@realar.com">
